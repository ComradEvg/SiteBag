...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"Header\": () => (/* binding */ Header)\n/* harmony export */ });\nclass Header {\r\n   constructor() {\r\n      this.decor = document.querySelector(\".header__bottom-decor\")\r\n      this.widthDecor = 100\r\n      this.platform = navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i)\r\n      this.burger = document.querySelector('.burger')\r\n      this.menu = document.querySelector('.header__menu')\r\n      this.upPageY = window.pageYOffset\r\n      this.flagMoveHeader = true;\r\n      this.lastKnownScrollPosition = window.scrollY;\r\n      this.header = document.querySelector('.header')\r\n   }\r\n   static heightHeader = document.querySelector('.header').clientHeight;\r\n   headerBegin() {\r\n      this.decor.style.height = this.menuDefaultValue()\r\n      this.header.style.height = this.menuDefaultValue()\r\n      window.addEventListener('resize', this.resize.bind(this), false)\r\n      this.mobileVersionChange(this.platform)\r\n      window.addEventListener('scroll', this.menuScroll.bind(this))\r\n   }\r\n   \r\n   mobileVersionChange(platform) {\r\n      Header.heightHeader = document.querySelector('.header').clientHeight\r\n      if (platform) {\r\n         this.burger.style.display = 'block'\r\n         this.menu.classList.add('header-mobile')\r\n         this.burger.addEventListener('click', this.burgerSwitch.bind(this))\r\n         }\r\n      else { \r\n            this.decor.style.zIndex = '-1'\r\n            if (this.menu.classList.contains('header-mobile')) {\r\n               this.menu.classList.remove('header-mobile')\r\n            }\r\n         }\r\n   }\r\n   burgerSwitch() {\r\n      let menuMirrorInSwitch = this.menu\r\n   if (!this.burger.classList.contains('burger-unlock')) {\r\n      this.burger.classList.add('burger-unlock')\r\n      this.widthUp(menuMirrorInSwitch)\r\n   }\r\n   else {\r\n      this.widthDown(menuMirrorInSwitch)\r\n      }\r\n      \r\n   }\r\n   widthUp() {\r\n   this.widthDecor -= 1\r\n   this.decor.style.width = `${this.widthDecor}%`\r\n   if (this.widthDecor > 80) {\r\n         window.requestAnimationFrame(this.widthUp.bind(this))\r\n         }\r\n   else {\r\n      this.menu.classList.add('menu-unlock');\r\n      document.body.style.overflowY = 'hidden';\r\n         }\r\n   }\r\n   widthDown() {\r\n   this.widthDecor += 1\r\n   this.decor.style.width = `${this.widthDecor}%`\r\n   if (this.widthDecor < 100) {\r\n      window.requestAnimationFrame(this.widthDown.bind(this))\r\n   }\r\n   else {\r\n      this.burger.classList.remove('burger-unlock')\r\n      this.menu.classList.remove('menu-unlock')\r\n      document.body.style.overflowY = 'visible';\r\n   }\r\n   }\r\n   resize() {\r\n      Header.heightHeader = document.querySelector('.header').clientHeight\r\n      this.platform = navigator.userAgent.match(/Android|webOS|iPhone|iPad|iPod|BlackBerry|BB|PlayBook|IEMobile|Windows Phone|Kindle|Silk|Opera Mini/i)\r\n      if (this.platform) {\r\n         this.burger.style.display = 'block'\r\n         this.menu.classList.add('header-mobile')\r\n         this.decor.style.zIndex = '0'\r\n      }\r\n      else {\r\n         this.burger.style.display = 'none'\r\n         this.menu.classList.remove('header-mobile')\r\n         this.decor.style.zIndex = '-1'\r\n      }\r\n   }\r\n\r\n   menuScroll() {\r\n      this.upPageY = window.pageYOffset;\r\n      this.lastKnownScrollPosition = window.scrollY;\r\n      if(this.lastKnownScrollPosition > 20 && this.flagMoveHeader) {\r\n         let necesseryHeight = Header.heightHeader / 100 * 80\r\n         let newHeight = Header.heightHeader\r\n         function headerMove() {\r\n            if (newHeight > necesseryHeight) {\r\n               let header = document.querySelector('.header')\r\n               let decor = document.querySelector(\".header__bottom-decor\")\r\n               header.style.height = `${newHeight -= 0.5}px`\r\n               decor.style.height = `${newHeight -= 0.5}px`\r\n               Header.heightHeader = newHeight\r\n               window.requestAnimationFrame(headerMove)\r\n            }\r\n         }\r\n         if (this.flagMoveHeader) {\r\n            this.flagMoveHeader = false\r\n            headerMove()\r\n         }\r\n      }\r\n      else if (this.lastKnownScrollPosition == 0 && !this.flagMoveHeader) {\r\n         let necesseryHeight = Header.heightHeader * 100 / 80\r\n         let newHeight = Header.heightHeader\r\n         function headerMoveDown() {\r\n            if (newHeight < necesseryHeight) {\r\n               let header = document.querySelector('.header')\r\n               let decor = document.querySelector(\".header__bottom-decor\")\r\n               header.style.height = `${newHeight += 0.5}px`\r\n               decor.style.height = `${newHeight += 0.5}px`\r\n               Header.heightHeader = newHeight\r\n               window.requestAnimationFrame(headerMoveDown)\r\n            }\r\n         }\r\n         this.flagMoveHeader = true\r\n         headerMoveDown()\r\n      }\r\n   }\r\n   menuDefaultValue() {\r\n      if (this.lastKnownScrollPosition != 0) {\r\n         this.flagMoveHeader = false\r\n         return `${Header.heightHeader / 100 * 80\r\n            }px`\r\n      }\r\n      else{\r\n         return `${Header.heightHeader}px`\r\n      }\r\n   }\r\n}\r\n\n\n//# sourceURL=webpack://bag/./src/js/modules/header.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"main\": () => (/* binding */ main)\n/* harmony export */ });\n/* harmony import */ var _header_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./header.js */ \"./src/js/modules/header.js\");\n/* harmony import */ var _anime_es_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./anime.es.js */ \"./src/js/modules/anime.es.js\");\n/* harmony import */ var _swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./swiper-bundle.min.js */ \"./src/js/modules/swiper-bundle.min.js\");\n\r\n\r\n\r\n\r\nconst main = () => {\r\n   function ibgmy() {\r\n      const ibgs = document.getElementsByClassName('ibg');\r\n      for (let ibg of ibgs) {\r\n         const img = ibg.children[0];\r\n         const imgsrc = img.getAttribute(\"src\");\r\n         ibg.style.backgroundImage = `url(\"${imgsrc}\")`;\r\n      }\r\n   }\r\n   ibgmy()\r\n\r\n   \r\n   const mainBlock = document.querySelector('.main-screen__box');\r\n   mainBlock.style.paddingTop = `${_header_js__WEBPACK_IMPORTED_MODULE_0__.Header.heightHeader - 1}px`\r\n   window.addEventListener('resize', () => {\r\n      mainBlock.style.paddingTop = `${_header_js__WEBPACK_IMPORTED_MODULE_0__.Header.heightHeader - 1}px`\r\n   })\r\n\r\n   let animeLogo = document.querySelectorAll('.decor-delimiter__image')\r\n\r\n   let animeLogoBox = document.querySelectorAll('.decor-delimiter')\r\n\r\n   animeLogoBox[0].innerHTML = ''\r\n   let width = window.screen.width\r\n   let leftImageProperty = -90\r\n   let arrayImage = []\r\n\r\n   while ((arrayImage.length == 0) || (arrayImage[arrayImage.length - 1][1] <= width)) {\r\n      let newImage = document.createElement('img');\r\n      newImage.className = 'decor-delimiter__image'\r\n      newImage.id = `decor-image${arrayImage.length}`\r\n      if (arrayImage.length != 0) {\r\n         leftImageProperty = arrayImage[arrayImage.length - 1][1]\r\n         newImage.style.left = `${leftImageProperty += 90}px`\r\n      } else {\r\n         newImage.style.left = `${leftImageProperty}px`\r\n      }\r\n      newImage.src = animeLogo[0].getAttribute('src')\r\n      arrayImage.push([newImage, leftImageProperty])\r\n   }\r\n   \r\n   arrayImage.forEach((current) => {\r\n      animeLogoBox[0].insertAdjacentElement('beforeend', current[0]);\r\n   })\r\n   \r\n   let elements = document.querySelectorAll('.decor-delimiter__image');\r\n   _anime_es_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"].speed = 0.15\r\n\r\n   ;(0,_anime_es_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])({\r\n      targets: elements,\r\n      translateX: 90,\r\n      loop: true,\r\n      easing: 'linear',\r\n   });\r\n\r\n   let swiperList = `<img src=\"../image/icons/icons.svg#octagon-fill-svgrepo-com\" class=\"svg-octagon-fill-svgrepo-com-dims\"\r\n      alt=\"octagon-fill-svgrepo-com\"/>`\r\n   \r\n   const swiper = new _swiper_bundle_min_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('.swiper', {\r\n      loop: true,\r\n      pagination: {\r\n         el: \".swiper-pagination\",\r\n         dynamicBullets: true,\r\n         renderBullet: function (index, className) {\r\n            return `<div class='${className}'>${(swiperList)}\r\n            </div>`\r\n         }\r\n      },\r\n   })\r\n}\n\n//# sourceURL=webpack://bag/./src/js/modules/main.js?");
